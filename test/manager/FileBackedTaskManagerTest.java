...
public class FileBackedTaskManagerTest {
    ...
    public void tasksShouldBeWrittenInFileAfterCreate() throws IOException {
        ...
        assertEquals("4", substrings.get(7).get(5), "Седьмая строка содержит parent ID на шестом месте");
        ...
        assertEquals("5", substrings.get(8).get(5), "Восьмая строка содержит parent ID на шестом месте");
        ...
        assertEquals("6", substrings.get(9).get(5), "Девятая строка содержит parent ID на шестом месте");
    }
    ...
    public void tasksShouldBeDeletedFromFileAfterDelete() throws IOException {
        ...
        assertEquals("6", substrings.get(3).get(5), "Третья строка содержит parent ID на шестом месте");
    }
